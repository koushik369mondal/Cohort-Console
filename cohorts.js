 ...
 *   2. Ensure the corresponding student JSON file (e.g., `b-tech-2025-29.json`) is placed in the project root.
...
const cohorts = [
  ...
  ,
  {
    ...
    subtitle: "Student Cohort",
    studentCount: 0,
    studentsFile: "b-tech-2025-29.json",
    department: "Computer Science & Engineering",
  ...
  },
  {
    ...
    subtitle: "Student Cohort",
    studentsFile: "b-tech-2026-30.json",
    department: "Computer Science & Engineering",
